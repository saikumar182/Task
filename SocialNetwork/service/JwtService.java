...
public class JwtService {
    ...
    private String createToken(Map<String, Object> claims, String username) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 500000 * 60 * 60))
                .signWith(getSeckey(), SignatureAlgorithm.HS256).compact();
    }


    private Key getSeckey() {
        byte[] keybytes = Decoders.BASE64.decode("1XtG36arsJyDxqQlulz2Xgazdx47jke89518FFE45A59B889ACFB8D3CE8E1D");
